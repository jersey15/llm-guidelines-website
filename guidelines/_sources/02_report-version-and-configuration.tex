...
Furthermore, detailed documentation of the configuration and parameters used during the study is necessary for reproducibility. \comment{duplicate with previous sentence which talks also about configuration. try to consolidate?}
Our recommendations is to report: \comment{is there something missing here?}
